...
urlpatterns = [
    ...
    path('api/v1/admin/committee/', CommitteeAssignmentListCreateView.as_view(), name='admin-committee'),
    path('api/v1/admin/committee/<int:assignment_id>/', CommitteeAssignmentUpdateView.as_view(), name='admin-committee-update'),
